...
#
def save_checkpoint(state, is_best, args, best_filename, filename):
    ...
    if args.model_dir:
        ...
        #filename = os.path.join(args.data + 'models', filename)
        #best_filename = os.path.join(args.data + args.arch + 'models', best_filename)
